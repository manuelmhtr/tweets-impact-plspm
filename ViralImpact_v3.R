...
tweetsInner = rbind(UserEngagement, MessageSensitive, UserActivity, MessageExtension, UserCommitment, UserInteraction, MessagewithMedia, UserAudience, Environment, AmplifyImpact, ActionImpact)
...
tweetsOuter = list(userEngagement_cols, messageSensitive_cols, userActivity_cols, messageExtension_cols, userCommitment_cols, userInteraction_cols, messagewithMedia_cols, userAudience_cols, environment_cols, amplifyImpact_cols, actionImpact_cols)
